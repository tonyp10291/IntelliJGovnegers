...
import lombok.RequiredArgsConstructor;                      // L6
import org.springframework.http.*;
import org.springframework.web.bind.annotation.*;
import org.springframework.web.client.RestTemplate;
import kr.co.govengers.service.OrderSvc;                   // L10
import java.util.List;                                     // L11 [추가]
...
@Slf4j
@RequiredArgsConstructor                                  // L20
public class PaymentController {

    private final RestTemplate restTemplate = new RestTemplate();
    private final ObjectMapper objectMapper = new ObjectMapper();
    private final OrderSvc orderSvc;                       // L25
    ...
    // TODO: 운영/개발 키는 application.yml 로 분리 권장
...
//            paymentData.put("quantity", request.get("quantity"));//*
    ...
    // L364~L409: getAccessToken 전체 교체
