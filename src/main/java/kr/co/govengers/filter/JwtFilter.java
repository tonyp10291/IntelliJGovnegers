...
//                || path.equals("/api/request-password-reset") || path.equals("/api/reset-password")
//                || path.equals("/api/find-id") || path.equals("/api/find-id-by-email")) {
...
//            final String uid = jwtUtil.getUidFromToken(jwt);
